...
mod block_header_tests {
    ...
    fn test_block_header_serialization() {
        let block = BlockHeader::new(500, 400, 0xAABBCCDD, 6)
            .expect("BlockHeader creation failed");
    ...
    fn test_block_header_roundtrip() {
        let original = BlockHeader::new(65535, 60000, 0x11223344, 9)
            .expect("BlockHeader creation failed");
...
mod checksum_tests {
    ...
    mod crc32_tests {
        ...
        fn test_crc32_known_value() {
            ...
            assert_eq!(crc, 0xCBF43926, "CRC-32 of '123456789' should match known value");
        }
        ...
        fn test_crc32_incremental() {
            ...
            assert_eq!(crc_once, crc_incremental, "Incremental CRC should match single-pass");
        }
